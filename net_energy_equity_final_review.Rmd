...
inset_bb <- st_buffer(st_as_sfc(st_bbox(inset_map_data)) %>% st_transform(3857), dist=10000)
...
gg_inset_map = ggdraw() +
  ...
  draw_plot(choropleth_chart_highlight, x = 0.175, y = 0.625, width = 0.35, height = 0.35)
