...
This paper utilizes the framing relative to the Federal Poverty Level and that relative to Area Median Income, so the methods will run a loop to process each of these datasets.
